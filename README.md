...
Create, and start version **0.14.1** of the **tinygo** [Gearbox](https://github.com/gearboxworks/) container and run a shell with commands.

**./bin/launch shell tinygo:0.14.1 ls -l**

```
me@home:~ % ./bin/launch shell tinygo:0.14.1 ls -l
Gearbox: Gear 'tinygo:0.14.1' already started.
total 60
...
**./bin/launch shell tinygo:0.14.1 ps -eaf**

```
me@home:~ % ./bin/launch shell tinygo:0.14.1 ps -eaf
Gearbox: Gear 'tinygo:0.14.1' already started.
...
+----------+----------------------------------+-------+--------+
| graphics | gearboxworks/tinygo:0.14.1  |       |  40 MB |
+----------+----------------------------------+-------+--------+
...
+---------------------+----------+---------+----------------------------------+-------+----------+---------------+--------+--------+
| tinygo-0.14.1  | graphics | created | gearboxworks/tinygo:0.14.1  |       |          | (gearboxnet)  |        |  40 MB |
|                     |          |         |                                  |       |          |               |        |        |
+---------------------+----------+---------+----------------------------------+-------+----------+---------------+--------+--------+
...
`./bin/launch run tinygo:0.14.1 -flag1 -flag2 variable1 variable2 variable3`
...
The **tinygo** [Gearbox](https://github.com/gearboxworks/) container has the following **3** available commands:
| Host Executable Name | [Gearbox](https://github.com/gearboxworks/) Container Executable Name |
| -------------------- | ---------------------------------------- |
|(default command) | /usr/bin/example |
...
* * *
**Note: This README was generated by `launch - v1.7.9` - Created on 2021-04-27T13:20:58+1000, using template:README.md.tmpl and json:gearbox.json**